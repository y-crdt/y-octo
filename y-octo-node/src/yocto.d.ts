...
export declare export declare function applyUpdate(doc: Doc, update: Buffer): void

export declare export declare function compareIds(a?: YId | undefined | null, b?: YId | undefined | null): boolean

export declare export declare function compareStructStores(store: YStore, other: YStore): boolean

export declare export declare function createDeleteSetFromStructStore(store: YStore): YDeleteSet

export declare export declare function encodeSnapshot(snapshot: YSnapshot): Buffer

export declare export declare function encodeStateAsUpdate(doc: Doc, state?: Buffer | undefined | null): Buffer

export declare export declare function encodeStateVector(doc: Doc): Buffer

export declare export declare function equalDeleteSets(a: YDeleteSet, b: YDeleteSet): boolean

export declare export declare function isAbstractType(obj?: any): boolean

export declare export declare function mergeUpdates(updates: Array<Buffer>): Buffer

export declare export declare function snapshot(doc: Doc): YSnapshot
