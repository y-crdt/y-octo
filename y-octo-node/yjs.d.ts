...
export function iterateDeletedStructs(
  ...
  ds: DeleteSet,
  f: (arg0: InternalStruct.GC | InternalStruct.Item) => void,
): void;
...
export class Doc extends ObservableV2<DocEvents> {
  ...
  gc: boolean;
  gcFilter: (arg0: InternalStruct.Item) => boolean;
  clientID: number;
  guid: string;
  ...
  getArray<T_1>(name?: string | undefined): YArray<T_1>;
  getText(name?: string | undefined): YText;
  getMap<T_2>(name?: string | undefined): YMap<T_2>;
  getXmlElement(name?: string | undefined): YXml.YXmlElement;
  getXmlFragment(name?: string | undefined): YXml.YXmlFragment;
  /**
...
type DocOpts = {
   ...
   */
  gcFilter?: ((arg0: InternalStruct.Item) => boolean) | undefined;
  /**
...
export function readUpdateV2(
  ...
  structDecoder?: UpdateDecoderV1 | UpdateDecoderV2 | undefined,
): void;
...
export function applyUpdateV2(
  ...
  update: Uint8Array,
  transactionOrigin?: any,
  YDecoder?: typeof UpdateDecoderV1 | typeof UpdateDecoderV2 | undefined,
): void;
...
export function encodeStateAsUpdateV2(
  ...
  encoder?: UpdateEncoderV2 | UpdateEncoderV1 | undefined,
): Uint8Array;
...
export function encodeStateVectorV2(
  ...
  encoder?: DSEncoderV1 | DSEncoderV2 | undefined,
): Uint8Array;
...
export function isParentOf(
  ...
  child: InternalStruct.Item | null,
): boolean;
...
declare namespace RelativePosition {
  /**
...
declare namespace Snapshot {
  ...
  export function decodeSnapshotV2(
    buf: Uint8Array,
    decoder?: DSDecoderV1 | DSDecoderV2 | undefined,
  ): Snapshot;
...
export class StructStore {
  clients: Map<number, Array<InternalStruct.GC | InternalStruct.Item>>;
  pendingStructs: {
...
export function findIndexSS(
  structs: Array<InternalStruct.Item | InternalStruct.GC>,
  clock: number,
): number;
export function getItem(arg0: StructStore, arg1: ID): InternalStruct.Item;
...
declare namespace UndoManager {
  ...
  export class UndoManager extends ObservableV2<{
    ...
    doc: Doc;
    deleteFilter: (arg0: InternalStruct.Item) => boolean;
  ...
  type UndoManagerOptions = {
     ...
     * undo/redo scope.
     */
    deleteFilter?: ((arg0: InternalStruct.Item) => boolean) | undefined;
...
export function decodeUpdate(update: Uint8Array): {
  structs: (InternalStruct.GC | InternalStruct.Item | InternalStruct.Skip)[];
  ds: DeleteSet;
};
...
export function encodeStateVectorFromUpdateV2(
  update: Uint8Array,
  YEncoder?: typeof DSEncoderV1 | typeof DSEncoderV2,
  YDecoder?: typeof UpdateDecoderV1 | typeof UpdateDecoderV2,
): Uint8Array;
...
export function mergeUpdatesV2(
  ...
  YDecoder?: typeof UpdateDecoderV1 | typeof UpdateDecoderV2 | undefined,
  YEncoder?: typeof UpdateEncoderV2 | typeof UpdateEncoderV1 | undefined,
): Uint8Array;
...
export class YEvent<T extends AbstractType<any>> {
   ...
   */
  deletes(struct: InternalStruct.AbstractStruct): boolean;
  get keys(): Map<
    string,
    {
   ...
   * In contrast to change.deleted, this method also returns true if the struct was added and then deleted.
   */
  adds(struct: InternalStruct.AbstractStruct): boolean;
  /**
   * This is a computed property. Note that this can only be safely computed during the
   * event call. Computing this property after other changes happened might result in
   * unexpected behavior (incorrect computation of deltas). A safe way to collect changes
   ...
   */
  get changes(): {
    added: Set<InternalStruct.Item>;
    deleted: Set<InternalStruct.Item>;
    keys: Map<
      string,
      {
        action: "add" | "update" | "delete";
...
export class YText extends AbstractType<YTextEvent> {
  ...
  toDelta(
    ...
    computeYChange?: ((arg0: "removed" | "added", arg1: ID) => any) | undefined,
  ): any;
  /**
...
declare namespace YXml {
  ...
  export class YXmlFragment extends AbstractType<YXmlEvent> {
     ...
     */
    insertAfter(
      ref: null | InternalStruct.Item | YXmlElement | YXmlText,
...
declare namespace InternalStruct {
